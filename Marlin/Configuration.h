...
// Enable the BLTouch alterations on the AnyCubic Mega S
// Configures the probe pins and enables babystepping
//#define CYL_BLTOUCH_ENABLED
...
#if EITHER(CYL_BLTOUCH_ENABLED, Z_SAFE_HOMING)
